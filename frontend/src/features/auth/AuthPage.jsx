    ...
    <div className="auth-page">
        ...
        <div className="hero-content">
          ...
          <div className="chat-mock">
            <div className="chat-toolbar">
              <button aria-label="Like"><i className="fas fa-thumbs-up"></i></button>
              <button aria-label="Copy"><i className="fas fa-copy"></i></button>
              <button aria-label="Regenerate"><i className="fas fa-sync"></i></button>
      ...
      <section className="auth-section">
        <div className="auth-panel-header">
          <div>
            <h1 className="auth-title">{mode === 'signup' ? 'Sign up with free trial' : 'Sign in to continue'}</h1>
        ...
        {session ? (
          ...
          <form className="auth-form" onSubmit={handleSubmit}>
            ...
            <p className="consent-text">
              By registering for an account, you are consenting to our <a href="#" className="consent-link">Terms of Service</a> and confirming that you have reviewed and accepted the <a href="#" className="consent-link">Global Privacy Statement</a>.
            </p>

            <button type="submit" className="auth-btn primary" disabled={loading}>
              {loading ? 'Please wait...' : mode === 'signin' ? 'Sign in' : 'Get started free'}
            </button>
